...
?>
 <form class="form-inline" action="php/updatechart.php" method="post"  style=" width: 100%">
          <div class="container" >
          <input type="text" class="form-control"  name="child_id" value=<?php if(isset($child_data['child_id'])) echo $child_data['child_id']; ?>>
