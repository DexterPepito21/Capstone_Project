...
if(isset($_POST['forgot'])){
  ...
  $mail->Body    = '<a href="http://localhost/newcaps/Capstone_Project/adminverify.php?email='.$email.'">Click this link to reset your password</a>';
...
if(!$mail->send()) {
    ...
    echo "<SCRIPT>
      ...
      echo "<SCRIPT>
          alert('$message')
          window.location.replace('admin_forgot.php');
      </SCRIPT>";
    }
...
<body>
      <form action="adminforgot.php" class="modal-content" method="POST">
