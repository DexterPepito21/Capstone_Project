...
if(isset($_POST['forgot'])){
    ...
    $sql = "SELECT * FROM parent_tbl WHERE email=?";
  ...
  $mail->Body    = '<a href="http://localhost/newcaps/Capstone_Project/forgotverify.php?email='.$email.'">Click this link to reset your password</a>';
...
<body>
      <form action="forgot.php" class="modal-content" method="POST">
